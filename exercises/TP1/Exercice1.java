...
public class Exercice1 {
	...
	/*
	String[] tableau1 = new String[3];
	tableau1[0] = "Impossible" ; tableau1[1] = "Damn" ;  tableau1[2] = "OK";
	for (int i = 0 ; i < tableau1.length ; i++) {
		System.out.println(tableau1[i]);
	}

	String[] Exttt = agrandirTab(tableau1);
	for (int i = 0 ; i < Exttt.length ; i++) {
		System.out.println(Exttt[i]);
	}
	*/
